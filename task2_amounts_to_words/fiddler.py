...
def zlote(amount):
    ...
    setki = (setki - liczba_setek) * 100

    return kwota_slownie, setki


def grosze(liczba_groszy):
    ...
    formed_grosze = grosze + liczba_groszy_slownie

    return formed_grosze
...
def fakturowanie(amount):
    ...
    formed_amount_zlote, liczba_setek = zlote(amount)
    liczba_groszy = liczba_setek // 1
    formed_amount_grosze = grosze(liczba_groszy)
